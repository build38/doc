...
Functions marked as `alwaysinline` are skipped to let the call-site be inlineable. As mentioned
above, one may incur performance penalties due to the overhead coming from the further layer of
indirection.
